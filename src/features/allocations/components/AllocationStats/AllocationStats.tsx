...
export const AllocationStats = ({ stats }: AllocationStatsProps) => {
  const statItems = [
    { key: 'total', value: stats.total, label: 'Total Allocations', icon: <AssignmentIcon />, color: '#3B82F6' },
    ...
    { key: 'releasingSoon', value: stats.releasingSoon, label: 'Releasing Soon', icon: <ScheduleIcon />, color: '#F59E0B' },
  ];
