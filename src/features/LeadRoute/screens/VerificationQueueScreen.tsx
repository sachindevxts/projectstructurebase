...
import { cx, prospects, Tag } from './LeadRouteScreenShared';
    ...
    <main className={cx(styles.content, styles.contentWide)}>
      <Box className={styles.queueLayout}>
        <Box className={styles.queueList}>
          ...
          {prospects.map(([name, company], index) => (
            <Box className={cx(styles.queueItem, index === 0 && styles.queueItemActive)} key={name}>
          ...
          <Box className={cx(styles.panel, styles.panelPad)}>
            <Box display="flex" justifyContent="space-between">
              <Box>
                ...
                <Typography color="text.secondary">Decision Maker · Ramp</Typography>
              </Box>
              <Box className={styles.buttonRow}>
            ...
            <Box className={cx(styles.grid, styles.grid3)} mt={3}>
              <Box>
                ...
                <Typography>j.obrien@ramp.com</Typography>
              </Box>
              <Box>
                <Typography color="text.secondary" fontSize={12}>
                  HubSpot Contact
